...
public class ODataConnection {
	...
	String httpHeaderAccept = HttpContentType.APPLICATION_JSON;
	
	String httpHeaderConnectType = HttpContentType.APPLICATION_JSON;
	
	//TODO: Add Proxy support to the command
	private Proxy proxy = new Proxy(Proxy.Type.HTTP, new InetSocketAddress("proxy", 8080));
