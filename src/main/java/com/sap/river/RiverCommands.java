...
@Service
public class RiverCommands implements CommandMarker { // All command types must implement the CommandMarker interface
    ...
    /**
     * Get a reference to the RiverOperations from the underlying OSGi container
     */
    @Reference private RiverOperations operations; 
    ...
    protected void activate(ComponentContext context) {
        staticFieldConverter.add(RiverPropertyName.class);
    }
    ...
    protected void deactivate(ComponentContext context) {
        staticFieldConverter.remove(RiverPropertyName.class);
    }
    ...
    public void sayHello(
        ...
        @CliOption(key = "countryOfOrigin", mandatory = false, help = "Country of orgin") RiverPropertyName country) {
        
        log.info("Welcome " + name + "!");
        log.warning("Country of origin: " + (country == null ? RiverPropertyName.NOT_SPECIFIED.getPropertyName() : country.getPropertyName()));
