...
//	private static Logger LOGGER = Logger.getLogger(PersistenceOperationsImpl.class.getName());
	...
	private void updatePersistenceXml() 
	{
        ...
        final String persistenceUnit = "persistenceUnit";
        ...
        persistenceUnitElement = XmlUtils.findFirstElement(PERSISTENCE_UNIT + "[@name = '"
		...
		properties.appendChild(createPropertyElement(
				"eclipselink.ddl-generation", "create-tables", persistence));
		properties.appendChild(createPropertyElement(
    ...
    private void updateApplicationContext()
    {
        ...
        final String contextPath = projectOperations.getPathResolver()
                .getFocusedIdentifier(Path.SPRING_CONFIG_ROOT, APPLICATION_CONTEXT_XML);
        ...
        final String dbPropsPath = projectOperations.getPathResolver()
                .getFocusedIdentifier(Path.SPRING_CONFIG_ROOT, DATABASE_PROPERTIES_FILE);
    ...
    private void updateWebXML()
    {
        ...
        fileManager.createOrUpdateTextFileIfRequired(webXMLPath,
                XmlUtils.nodeToString(webXMLDoc), false);
    }
